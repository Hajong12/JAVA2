...
public class IntegerTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("num2가 포장하고 잇는 정수는 : " + num2);
		System.out.println("두수의 합 + " + num2);
		System.out.println("합의 2진 표현 : " + Integer.toBinaryString(num2));
		System.out.println("합의 8잔 표현 : " + Integer.toOctalString(num2));
		...
		System.out.println("2진수 '1001001의 10진 값은 : " + Integer.parseInt("1001001",2));
	}
